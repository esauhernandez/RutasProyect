...
import com.ehp.rutas.login.presenter.CreateAccountPresenterImpl;
...
public class CreateAccountActivity extends AppCompatActivity implements CreateAccountView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtEmail.setText("esau.hdez.p@gmail.com");
        edtName.setText("Esau");
        edtUser.setText("esauhp");
        edtPassword.setText("1111");
        edtPasswordConfirm.setText("1111");
        ...
        btnJoinUs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(user.getPassword().length() < 6){
                    Toast.makeText(CreateAccountActivity.this, "Password tiene que tener mínimo 6 caracteres", Toast.LENGTH_SHORT).show();
                    return;
                }
